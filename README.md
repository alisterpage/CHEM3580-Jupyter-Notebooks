...
* **forcefield_decomposition** - Lecture 1. The Anatomy of a MD Forcefield - what are the terms in a forcefield, and how do they work together?
...
* **Homework 2** - Water Density vs Water Models.
* **Homework 3** - Predicting Water Heat Capacity using MD.

## Workshop Notebooks

* **Workshop 1** - Introduction to running MD simulations in Python & Jupyter Notebooks. Simulating Electrolytes and Specific Ion Effects in Water. 
* **Workshop 2** - Hydrogen Bonding in Deep Eutectic Solvents.
* **Workshop 3** - Micelles under the Microscope.
